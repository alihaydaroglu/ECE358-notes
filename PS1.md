...
$$
\begin{align}
(\lambda_i \mathbf I - \mathbf A)v_i & = 0 \\
\end{align} \tag {4.2}
$$
This gives:
$$
...
$$
\begin {align}
x_p(t) & =  \mathbf \Phi (t) \int_0^t \mathbf \Phi ^{-1} (t) \mathbf B u(s)ds \\ \\
& =
    \begin{bmatrix}
        7e^{5t} & e^{-t}
        \\
...
$$
2 = 7c_1 + c_2 + \frac 1{15} \\
1 = c_1 + c_2 + \frac {10}{15} \tag{5.5}
$$
